...
class LoginActivity : BaseActivity(), View.OnClickListener {
    private val mEdPhone by R.id.login_ed_phone.view<EditText>()
    private val mEdCode by R.id.login_ed_code.view<EditText>()
    private val mBtnGetCode by R.id.login_btn_get_code.view<Button>()
